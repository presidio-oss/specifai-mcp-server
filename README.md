...
Make sure your project root directory contains a `.specif-ai-path` file. It's how the Specifai MCP server know where to find the specification documents generated by Specifai.
...
- [Specifai](https://github.com/presidio-oss/specif-ai) - The project this server integrates with
